...
<head>
    ...
    <title>PA Kandangan</title>
    <meta content="Persyaratan pendaftaran perkara pada Pengadilan Agama Kandangan" name="description" />
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="index.html" class="logo me-auto">
                <img src="assets/img/pa_kandangan.png" alt="" class="img-fluid" />
                <img src="assets/img/wbk.png" alt="" class="img-fluid" />
                <img src="assets/img/berakhlak.png" alt="" class="img-fluid" />
            </a>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown">
                        <a href="#"><span>Gugatan <i class="bi bi-chevron-down"></i></span></a>
                        <ul>
                            <li><a href="#cerai" onclick="bunyi('cerai');">Cerai</a></li>
                            <li>
                                <a href="#gugat-waris" onclick="bunyi('gugat-waris');">Gugat Waris</a>
                            </li>
                            <li>
                                <a href="#hadhanah" onclick="bunyi('hadhanah');">Hak Asuh Anak</a>
                            </li>
                            <li>
                                <a href="#harta-bersama" onclick="bunyi('harta-bersama');">Harta Bersama / Gono-Gini</a>
                            </li>
                            <li>
                                <a href="#isbat-cerai" onclick="bunyi('isbat-cerai');">Isbat Nikah disertai Cerai</a>
                            </li>
                            <li>
                                <a href="#nafkah-anak" onclick="bunyi('nafkah-anak');">Nafkah Anak</a>
                            </li>
                            <li>
                                <a href="#pembatalan-nikah" onclick="bunyi('pembatalan-nikah');">Pembatalan Nikah</a>
                            </li>
                            <li>
                                <a href="#poligami" onclick="bunyi('poligami');">Izin Poligami</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#"><span>Permohonan <i class="bi bi-chevron-down"></i></span></a>
                        <ul>
                            <li>
                                <a href="#asal-usul-anak" onclick="bunyi('asal-usul-anak');">Asal Usul Anak</a>
                            </li>
                            <li>
                                <a href="#dispensasi-nikah" onclick="bunyi('dispensasi-nikah');">Dispensasi Nikah</a>
                            </li>
                            <li>
                                <a href="#isbat-nikah" onclick="bunyi('isbat-nikah');">Isbat Nikah atau Pengesahan
                                    Nikah</a>
                            </li>
                            <li>
                                <a href="#pencegahan-nikah" onclick="bunyi('pencegahan-nikah');">Pencegahan Nikah</a>
                            </li>
                            <li>
                                <a href="#penetapan-ahli-waris" onclick="bunyi('paw');">Penetapan Ahli Waris</a>
                            </li>
                            <li>
                                <a href="#pengangkatan-anak" onclick="bunyi('pengangkatan-anak');">Pengangkatan Anak</a>
                            </li>
                            <li>
                                <a href="#perwalian" onclick="bunyi('perwalian');">Perwalian</a>
                            </li>
                            <li>
                                <a href="#wali-adhal" onclick="bunyi('wali-adhal');">Wali Adhal</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a class="nav-link scrollto" href="#eksekusi" onclick="bunyi('eksekusi');">Eksekusi</a>
                    </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <h1>e-Persada</h1>
                    <h2>Elektronik Persyaratan Pendaftaran Perkara</h2>
                    <h2>Pengadilan Agama Kandangan</h2>
    ...
    <main id="main">
        <section id="gugatan" class="gugatan">
            <div class="container aos-init aos-animate" data-aos="fade-up">
                ...
                <section id="cerai" class="cerai section-bg" onclick="bunyi('cerai');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                            <h2>Cerai</h2>
                        </div>
                ...
                <section id="gugat-waris" class="gugat-waris section-bg" onclick="bunyi('gugat-waris');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                            <h2>Gugat Waris</h2>
                        </div>
                ...
                <section id="hadhanah" class="hadhanah section-bg" onclick="bunyi('hadhanah');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                ...
                <section id="harta-bersama" class="harta-bersama section-bg" onclick="bunyi('harta-bersama');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                ...
                <section id="isbat-cerai" class="isbat-cerai section-bg" onclick="bunyi('isbat-cerai');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                ...
                <section id="nafkah-anak" class="nafkah-anak section-bg" onclick="bunyi('nafkah-anak');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                            <h2>Nafkah Anak</h2>
                        </div>
                ...
                <section id="pembatalan-nikah" class="pembatalan-nikah section-bg" onclick="bunyi('pembatalan-nikah');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                ...
                <section id="poligami" class="poligami section-bg" onclick="bunyi('poligami');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                            <h2>Izin Poligami</h2>
                        </div>
        ...
        <section id="permohonan" class="permohonan">
            <div class="container aos-init aos-animate" data-aos="fade-up">
                ...
                <section id="asal-usul-anak" class="asal-usul-anak section-bg" onclick="bunyi('asal-usul-anak');">
                ...
                <section id="dispensasi-nikah" class="dispensasi-nikah section-bg" onclick="bunyi('dispensasi-nikah');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                            ...
                            <div class="col-md-12">
                                <ul class="list-group" id="bunyi-dispensasi-nikah">
                                    ...
                                    <li class="list-group-item dn">
                                        ...
                                        Agama Kandangan atau untuk keperluan persidangan di
                                        pengadilan.
                                    </li>
                                    <li class="list-group-item dn">
                ...
                <section id="isbat-nikah" class="isbat-nikah section-bg" onclick="bunyi('isbat-nikah');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="list-group" id="bunyi-isbat-nikah">
                                    ...
                                    <li class="list-group-item in">
                                        <strong>Persyaratan ini merupakan persyaratan awal, untuk
                ...
                <section id="pencegahan-nikah" class="pencegahan-nikah section-bg" onclick="bunyi('pencegahan-nikah');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                ...
                <section id="penetapan-ahli-waris" class="penetapan-ahli-waris section-bg" onclick="bunyi('paw');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                ...
                <section id="pengangkatan-anak" class="pengangkatan-anak section-bg"
                ...
                <section id="perwalian" class="perwalian section-bg" onclick="bunyi('perwalian');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                            <h2>Perwalian</h2>
                        </div>
                ...
                <section id="wali-adhal" class="wali-adhal section-bg" onclick="bunyi('wali-adhal');">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="section-title">
                            <h2>Wali Adhal</h2>
                        </div>
        ...
        <section id="eksekusi" class="eksekusi section-bg" onclick="bunyi('eksekusi');">
            <div class="container aos-init aos-animate" data-aos="fade-up">
                <div class="section-title">
    ...
    <footer id="footer">
        <div class="container footer-bottom clearfix">
            <div class="copyright">
                &copy; Copyright
                <strong><span><a href="pa.kandangan.go.id">Pengadilan Agama Kandangan</a></span></strong>. All Rights
                Reserved
            </div>
            <div class="credits">
    ...
    <script src="assets/js/mine.min.js"></script>
</body>
